...
STDMETHODIMP Application::patchProtocol(Scheme aScheme, BOOL aUseVTablePatching)
{
...
//  for completeness.
STDMETHODIMP Application::unpatchProtocol(Scheme aScheme)
{
  switch(mHandlerType) {
    case PAPP:
...
STDMETHODIMP Application::enableProtocol(Scheme aScheme, BOOL aEnable)
{
